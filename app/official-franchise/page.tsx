    ...
    <>
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-[999] flex items-center justify-center px-4">
          <div className="bg-white w-full max-w-md rounded-lg p-8 shadow-2xl relative">
            <button
            ...
            <div className="mb-8">
              <h2 className={`text-2xl font-semibold mb-3 text-gray-900 ${playfair.className}`}>
            ...
            <div className="space-y-5">
              <input
                ...
                className={`w-full px-4 py-3 border border-gray-200 focus:border-gray-400 outline-none transition-colors ${inter.className}`}
              />
              ...
              <div className="relative">
                <select
                  ...
                  className={`w-full px-4 py-3 border border-gray-200 focus:border-gray-400 outline-none transition-colors appearance-none cursor-pointer ${inter.className}`}
                >
              ...
              <button
                ...
                className={`w-full bg-gray-900 hover:bg-black text-white py-3 font-medium transition-colors flex items-center justify-center space-x-2 ${inter.className}`}
              >
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-gray-200">
              <div className="text-center">
                ...
                <div className={`text-gray-600 ${inter.className}`}>Delivery Time</div>
              </div>
              <div className="text-center">
                <div className={`text-4xl font-semibold text-gray-900 mb-2 ${playfair.className}`}>25+</div>
                <div className={`text-gray-600 ${inter.className}`}>Cities Available</div>
              </div>
              <div className="text-center">
                <div className={`text-4xl font-semibold text-gray-900 mb-2 ${playfair.className}`}>₹3.5Cr</div>
                <div className={`text-gray-600 ${inter.className}`}>Starting Investment</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            {[
              ...
              <div key={index} className="bg-white p-8 border border-gray-200 hover:border-gray-300 transition-colors">
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <h3 className={`text-2xl font-semibold text-gray-900 mb-8 ${playfair.className}`}>
                Financial Overview
              </h3>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={index} className="flex justify-between items-center py-4 border-b border-gray-200">
                    <div className={`text-gray-700 ${inter.className}`}>{item.label}</div>
                    <div className={`text-gray-900 font-semibold ${inter.className}`}>{item.value}</div>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="flex items-start space-x-3">
                    ...
                    <span className={`text-gray-700 ${inter.className}`}>{benefit}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="text-center mt-16">
            <button 
              onClick={() => setShowModal(true)}
              className={`bg-gray-900 hover:bg-black text-white px-12 py-4 font-medium transition-colors inline-flex items-center space-x-3 ${inter.className}`}
            >
            ...
            {[
              ...
              <div key={index} className="flex space-x-6">
                <div className="flex-shrink-0">
                  <div className={`w-12 h-12 border-2 border-gray-900 text-gray-900 flex items-center justify-center text-lg font-semibold ${inter.className}`}>
                    {item.number}
                  </div>
                </div>
                <div>
                  <h3 className={`text-2xl font-semibold text-gray-900 mb-4 ${playfair.className}`}>
                    {item.title}
                  </h3>
                  <p className={`text-gray-600 leading-relaxed ${inter.className}`}>
                    {item.desc}
      ...
      <section className="py-20 md:py-32 bg-gray-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className={`text-xl text-gray-300 mb-12 max-w-2xl mx-auto ${inter.className} font-light`}>
          ...
          <div className="flex justify-center mb-16">
            <button 
              onClick={() => setShowModal(true)}
              className={`bg-white text-gray-900 hover:bg-gray-100 px-12 py-4 font-medium transition-colors inline-flex items-center space-x-3 ${inter.className}`}
            >
              <span>Apply for Franchise</span>
              <FaArrowRight className="text-sm" />
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-gray-800">
            <div className="text-center">
              ...
              <div className={`text-gray-400 ${inter.className}`}>Starting Investment</div>
            </div>
            <div className="text-center">
              <div className={`text-3xl font-semibold text-white mb-2 ${playfair.className}`}>25+</div>
              <div className={`text-gray-400 ${inter.className}`}>Cities Available</div>
            </div>
            <div className="text-center">
              <div className={`text-3xl font-semibold text-white mb-2 ${playfair.className}`}>5%</div>
              <div className={`text-gray-400 ${inter.className}`}>Revenue Share</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="text-center mt-16">
            ...
            <button 
              onClick={() => setShowModal(true)}
              className={`text-gray-900 hover:text-black font-medium border-b border-gray-900 ${inter.className}`}
            >
