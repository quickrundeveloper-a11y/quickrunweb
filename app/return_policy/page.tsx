    ...
    <div className="w-full min-h-screen bg-[#f5f7fa] flex justify-center py-10">
      <div className="w-[92%] max-w-[1100px] bg-white rounded-3xl shadow-lg p-10 border border-gray-200">
        ...
        <div className="space-y-6 text-gray-800 leading-relaxed">
          ...
          {/* SECTION 1 */}
          <h2 className="text-xl font-bold">1. Our Policy on Returns</h2>
          <p>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li><strong>Order Not Delivered:</strong> You paid for an order that never arrived.</li>
            <li><strong>Incorrect Items:</strong> Items received differ significantly from what was ordered.</li>
            <li><strong>Damaged or Spoiled Items:</strong> Items arrived spoiled, damaged, or expired.</li>
            <li><strong>Missing Items:</strong> Certain items from your order are missing.</li>
          </ul>
          ...
          {/* SECTION 4 */}
          <h2 className="text-xl font-bold">4. Refund Processing</h2>
          <p>Refund process steps:</p>

          <ul className="list-disc ml-6 space-y-1">
            <li><strong>Review:</strong> We’ll verify your request and supporting evidence.</li>
            <li>
              <strong>Processing:</strong> Approved refunds will be issued either:
